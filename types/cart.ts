...
export type CartViewProps = {cartItems:CartItem[],cart:Cart, addToCart:(product:Product)=>void, removeFromCart:(product:Product)=>void, clearCart:()=>void, checkout:()=>void};